     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
			        <form role="form" action="<?= base_url()?>admin/product/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                         ...
                         <input type="text" name="product_name" class="form-control" id="" value="<?= @$_POST['product_name']?>" placeholder="Product Name">
                         <span class="text-danger"><?= form_error('product_name');?></span>
                      </div>

                       <div class="col-sm-4">
                         <label for="exampleInputPassword1">Other Name</label>
                         <input type="text" name="other_name" class="form-control" id="" value="<?= @$_POST['other_name']?>" placeholder="Other Name">
                         <span class="text-danger"><?= form_error('other_name');?></span>
                      </div>

                      <div class="col-sm-4">
                         <label for="exampleInputPassword1">MRP price</label>
                         <input type="text" name="mrp_price" class="form-control" id="" value="<?= @$_POST['mrp_price']?>" placeholder="mrp price">
                  ...
                  <div class="form-group">
                    <div class="row">
                       <!-- <div class="col-sm-4">
                         ...
                         <input type="hidden" name="price" class="form-control" id="" value="<?= @$_POST['price']?>" placeholder="price">
                      ...
                      <div class="col-sm-4">
                         ...
                         <select class="form-control" name="unit_id" >
                           ...
                           <?php
                            foreach ($unit as $uni) { ?>
                              <option value="<?= $uni['id']?>" ><?= $uni['unite_name'];?></option>
                           <?php } ?>
                         </select>
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                         ...
                         <input type="number" name="discount" class="form-control" id="" value="<?= @$_POST['discount']?>" placeholder="Discount">
                         <span class="text-danger"><?= form_error('discount');?></span>
                      </div>

                       <div class="col-sm-4">
                         <label for="exampleInputPassword1">Offer msg</label>
                         <input type="text" name="offer_msg" class="form-control" id="" value="<?= @$_POST['offer_msg']?>" placeholder="offer msg">
                         <span class="text-danger"><?= form_error('offer_msg');?></span>
                      </div>

                      <div class="col-sm-4">
                         <label for="exampleInputPassword1">No of product</label>
                         <input type="number" name="no_of_product" class="form-control" id="" value="<?= @$_POST['no_of_product']?>" placeholder="no of product">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-4 checkbox">
                         ...
                         <?php
                          foreach ($unit as $unt) { ?>
                            <input type="checkbox" name="addunits[]" value="<?= $unt['id']?>"><?= '&nbsp;'.$unt['unite_name']?>
                          <?php } ?>
                      </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         ...
                         <textarea class="form-control" cols="10" name="search_tags"><?= @$_POST['search_tags'];?></textarea>
                        <span class="text-danger"><?= form_error('search_tags');?></span>
                        <span class="text-danger">Please add tags with comma(,)</span>
                      </div>
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Description</label>
                         <textarea class="form-control" cols="10" name="description"><?= @$_POST['description'];?></textarea>
                      ...
                      <div class="col-sm-6">
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" name="files[]"  id="thumb_image" required="" multiple>
