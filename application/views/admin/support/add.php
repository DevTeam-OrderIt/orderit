     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?= base_url()?>admin/support/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                         ...
                         <select name="category" class="form-control">
                           ...
                           <option value="animal_walfare">Animal walfare</option>
                           <option value="envoirment_protection">Envoirment Protection</option>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-12">
                         ...
                         <input type="text" name="title" class="form-control" id="" value="" placeholder="Enter title">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="amount" class="form-control" id="" value="" placeholder="Enter amount">
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="raised" class="form-control" id="" value="" placeholder="Enter amount">
