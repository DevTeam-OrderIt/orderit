        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>admin/support/add"><i class="fas fa-plus"> </i> Add</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th><input type="checkbox"  id="select_all">SR. NO.</th>
                  <th>Title</th>
                  <th>Public date</th>
                  <th>Amount</th>
                  <th>Raised</th>
                ...
                <tr>
                  ...
                  <td><?= date("d, M Y g:s a", strtotime($row['datetime']));?></td>
                  <td><?= $row['amount']?></td>
                  <td><?= $row['raised']?></td>
                  <td><?= $row['days']?></td>
                  <td>
                    <a href="<?= base_url()?>admin/support/doner/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs">List</a>
                  </td>
                  <td style="white-space: nowrap;">
                      <a href="<?= base_url()?>admin/support/edit/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs"><i class="fas fa-pencil-alt"></i></a>
                      <a href="<?= base_url()?>admin/support/view/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs"><i class="far fa-eye"></i></a>
