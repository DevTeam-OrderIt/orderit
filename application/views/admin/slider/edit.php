     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <form role="form" action="<?= base_url()?>admin/slider/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-12">
                         <label for="exampleInputPassword1">Title</label>
                         <input type="text" name="title" class="form-control" id="" value="<?= $slider['title']?>" placeholder="Enter title">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                          <?php
                            if ($slider['images']!='') { ?>
                              <img class="show_image" src="<?= base_url()?>public/image_gallary/upload/<?= $slider['images']?>" width="100" height="100">
                           <?php } else { ?>
