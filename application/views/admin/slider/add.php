        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>admin/slider"><i class="fas fa-fast-backward"></i> Back</a></li>
     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?= base_url()?>admin/slider/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <textarea name="description" class="form-control" rows="3" class=""></textarea>
                  </div>
                     ...
                     <div class="row">
                       <div class="col-sm-6">
                        <div class="input-group">
                         ...
                         <span class="text-danger">Image dimension 1900 x 1200</span>
                      </div>
