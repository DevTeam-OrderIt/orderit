     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?= base_url()?>admin/user/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                         ...
                         <input type="text" name="first_name" class="form-control" id="" value="<?= @$_POST['first_name']?>" placeholder="First Name">
                         <span class="text-danger"><?= form_error('first_name');?></span>
                      </div>

                       <div class="col-sm-4">
                         <label for="exampleInputPassword1">Last Name</label>
                         <input type="text" name="last_name" class="form-control" id="" value="<?= @$_POST['last_name']?>" placeholder="Last Name">
                         <span class="text-danger"><?= form_error('last_name');?></span>
                      </div>

                      <div class="col-sm-4">
                         <label for="exampleInputPassword1">Mobile number</label>
                         <input type="text" name="phone" maxlength="10" class="form-control" id="" value="<?= @$_POST['phone']?>" placeholder="Mobile 10 digits">
                  ...
                  <div class="form-group">
                    <div class="row">
                       <div class="col-sm-4">
                         ...
                         <input type="email" name="email" class="form-control" id="" value="<?= @$_POST['email']?>" placeholder="Email Id">
                  ...
                  <div class="form-group">
                    <div class="row">
                       <div class="col-sm-3">
                         ...
                         <input type="text" name="door_no" class="form-control" id="" value="<?= @$_POST['door_no']?>" placeholder="door no">
                         <span class="text-danger"><?= form_error('door_no');?></span>
                      </div>
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">Floo no</label>
                         <input type="text" name="floo_no" class="form-control" id="" value="<?= @$_POST['floo_no']?>" placeholder="floo no">
                         <span class="text-danger"><?= form_error('floo_no');?></span>
                      </div>
                    
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">Building no</label>
                         <input type="text" name="building_no" class="form-control" id="" value="<?= @$_POST['building_no']?>" placeholder="building no">
                         <span class="text-danger"><?= form_error('building_no');?></span>
                      </div>
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">Appartment name</label>
                         <input type="text" name="appartment_name" class="form-control" id="" value="<?= @$_POST['appartment_name']?>" placeholder="appartment name">
                  ...
                  <div class="form-group">
                    <div class="row">
                       <div class="col-sm-3">
                         ...
                         <input type="text" name="street" class="form-control" id="" value="<?= @$_POST['street']?>" placeholder="street">
                         <span class="text-danger"><?= form_error('street');?></span>
                      </div>
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">Near by</label>
                         <input type="text" name="near_by" class="form-control" id="" value="<?= @$_POST['near_by']?>" placeholder="near by">
                         <span class="text-danger"><?= form_error('near_by');?></span>
                      </div>
                    
                     <div class="col-sm-3">
                         <label for="exampleInputPassword1">Locality</label>
                         <input type="text" name="locality" class="form-control" id="" value="<?= @$_POST['locality']?>" placeholder="locality">
                         <span class="text-danger"><?= form_error('locality');?></span>
                      </div>
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">City</label>
                         <input type="text" name="city" class="form-control" id="" value="<?= @$_POST['city']?>" placeholder="city">
                  ...
                  <div class="form-group">
                    <div class="row">
                       <div class="col-sm-3">
                         ...
                         <input type="text" name="district" class="form-control" id="" value="<?= @$_POST['district']?>" placeholder="district">
                         <span class="text-danger"><?= form_error('district');?></span>
                      </div>
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">State</label>
                         <input type="text" name="state" class="form-control" id="" value="<?= @$_POST['state']?>" placeholder="state">
                         <span class="text-danger"><?= form_error('state');?></span>
                      </div>
                    
                       <div class="col-sm-3">
                         <label for="exampleInputPassword1">Pincode</label>
                         <input type="text" name="pincode" maxlength="6" class="form-control" id="" value="<?= @$_POST['pincode']?>" placeholder="pincode">
