 <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
      <!-- <b>Developed By:</b> <a target="_blank" href="https://www.sevenstarwebsolutions.com/">seven star websolutions</a> -->
    </div>
  </footer>
  <!-- SweetAlert2 -->
...
<script>
  ...
  {
	 $.ajax({
		 url:'<?= base_url()?>admin/order/invoice_print/'+id,
		 type:'GET',
		 data:{},
		 success:function(html){
			var myWindow = window.open('','ajit','width=700,height=400');
