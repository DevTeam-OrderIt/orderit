     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <form role="form" action="<?= base_url()?>admin/category/add" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="name" class="form-control" id="" value="" placeholder="Enter Name">
                      </div>
