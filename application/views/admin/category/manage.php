        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class=""><a  class="breadcrumb-item btn btn-primary"href="<?= base_url()?>admin/category/add"><i class="fas fa-plus"> </i> Add</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="white-space: nowrap;">
                      <a href="<?= base_url()?>admin/category/edit/<?= $row['id']?>" class="btn bg-gradient-primary btn-xs"><i class="fas fa-pencil-alt"></i></a>
...
function deletes(){
   ...
   window.location.href='<?= base_url()?>admin/category/delete/'+deleteId;
}
