     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <form role="form" action="<?= base_url()?>admin/category/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Name</label>
                         <input type="text" name="name" class="form-control" id="" value="<?= $category['name']?>" placeholder="Enter Name">
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 pull-right">
                           <?php
                            if ($category['image']!='') { ?>
                              <img class="show_image" src="<?= base_url()?>public/image_gallary/upload/<?= $category['image']?>" width="100" height="100">
                           <?php } else { ?>
