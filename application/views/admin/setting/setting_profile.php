          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Change Admin Profile</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
			  <form role="form" action="<?= base_url()?>admin/setting/profile/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Username</label>
                    <input type="text" name="username" class="form-control" id="" value="<?= $admin['username']?>" placeholder="Enter Username">
                  </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="first_name" class="form-control" id="" value="<?= $admin['first_name']?>" placeholder="First Name">
                      </div>
                       <span><?= form_error('first_name');?></span>
                       <div class="col-sm-6">
                         <label for="exampleInputPassword1">Last Name</label>
                         <input type="text" name="last_name" class="form-control" id="" value="<?= $admin['last_name']?>" placeholder="Last Name">
                       </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         ...
                         <input type="text" name="mobile_number" class="form-control" id="" value="<?= $admin['mobile_number']?>" placeholder="Mobile Number">
                      </div>
                      <span><?= form_error('mobile_number');?></span>
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Email</label>
                         <input type="email" name="email" class="form-control" id="" placeholder="Email Id" value="<?= $admin['email']?>">
                      </div>
