     ...
     <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <form role="form" action="<?= base_url()?>admin/unite/update/<?= $id ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Name</label>
                         <input type="text" name="unite_name" class="form-control" id="" value="<?= $unit['unite_name']?>" placeholder="Enter Name">
                      </div>
                      <div class="col-sm-6">
                         <label for="exampleInputPassword1">Unite value</label>
                         <input type="text" name="unite_value" class="form-control" id="" value="<?= $unit['unite_value']?>" placeholder="Enter value">
                      </div>
                    </div>
                  </div>
